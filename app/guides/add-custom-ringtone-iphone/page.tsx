...
export default async function AddCustomRingtoneIphonePage() {
  return (
    <>
      <h1 className={styles.guides__title}>How to add a custom ringtone on iOS</h1>
      <p className={styles.guides__subtitle}>
        Learn how to set a custom ringtone for your calls or notifications from an audio file on
        your iPhone
      </p>

      <main className={styles.guides__main}>
        <p>
          To create a custom ringtone from an audio file on iOS right from your phone, you will need
          to use GarageBand.
        </p>
        ...
        <ol className={styles.guides__steps}>
          ...
          <li>
            ...
            <a href="https://apps.apple.com/us/app/garageband/id408709785" target="_blank">
              download it from the App Store
            </a>
            .
          </li>
          <li>
            Once it&apos;s installed, touch and hold the GarageBand app icon until the menu appears,
            then tap <b>Create New Audio Recording</b>.
          ...
          <li>
            Tap the instrument icon on the left to select the track, then tap the{' '}
            <b>Loops Browser</b> button at the top of the screen.
            <div className={`${styles.guides__imageContainer}`}>
              <Image
                src={loopsImage}
          ...
          <li>
            Choose the track you want to use for a ringtone: tap <b>Files</b>, then tap{' '}
            <b>Browse items</b> from the Files app.
            <div className={`${styles.guides__imageContainer}`}>
              <Image
                src={filesImage}
          ...
          <li>
            In the browser, tap and hold the song you just created, then tap the <b>Share</b>{' '}
            button.
            <div className={`${styles.guides__imageContainer}`}>
              <Image
                src={holdSongImage}
          ...
          <li>
            When the ringtone has finished exporting, tap <b>Use sound as</b>, then choose{' '}
            <b>Standard Ringtone</b> if you want to replace the current general ringtone, or choose{' '}
            <b>Text Tone</b> if you want to replace the existing general text tone.
            <div className={`${styles.guides__imageContainer}`}>
              <Image
                src={useAsImage}
